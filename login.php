            ...
            <div class="middle">
              <form action="./scripts/login.php" method="POST">
                <div class="flex flex-col justify-center gap-2">
                  ...
                  <input placeholder="soepandi" class="placeholder:text-slate-500 w-full max-w-sm border transition-all focus:outline-none focus:border-[#21AD95] border-black rounded-md h-10 ps-2" type="text" name="username" id="username-field">
                  <label class="text-sm mt-4" for="password-field">Password</label>
                  <input placeholder="******" class="placeholder:text-slate-500 w-full max-w-sm border transition-all focus:outline-none focus:border-[#21AD95] border-black rounded-md h-10 ps-2" type="password" name="password" id="password-field">
